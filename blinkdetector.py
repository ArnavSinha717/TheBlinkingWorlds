...
SERVER_ADDR = ("127.0.0.1", 9999)  # Godot listening on localhost:9999
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            if ear < EAR_THRESHOLD:
                ...
                if frame_counter >= CONSEC_FRAMES:
                    blink_count += 1
                    sock.sendto(b"blink", SERVER_ADDR)   # <-- send blink to Godot
                    print(f"Blink #{blink_count} sent to Godot")
                frame_counter = 0
